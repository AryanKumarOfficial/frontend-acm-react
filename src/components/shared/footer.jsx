        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-8">
            ...
            <dl className="space-y-16 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-16 sm:space-y-0 lg:gap-x-10">
                ...
                <footer className="">
                    ...
                    <div
                        className="container flex flex-wrap justify-between items-center gap-4 py-4 md:flex-row"> {/* Added flex-wrap and py-4 */}
                        {/* About section */}
                        <div className="flex flex-col space-y-2">
                            ...
                            <p className="text-base text-muted-foreground text-justify md:text-left">
                                ACM OIST-Bhopal is a student chapter highly focused on planning and organising events
                    ...
                    <div
                        className="container flex flex-col items-center justify-between gap-2 pt-4 pb-2 text-sm text-muted-foreground md:flex-row md:justify-center">
